...
#line 42 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = opr(AS, 3, var((yyvsp[-4].sString)), (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
...
#line 82 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = (yyvsp[0].nPtr); printf(" *** Applying simple expression \n");}
...
#line 86 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = (yyvsp[0].nPtr); printf(" #### Applying term production \n");}
